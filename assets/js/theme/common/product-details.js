...
import customProductTabs from '../custom/custom-product-tabs';
import FloatingLabel from '../custom/floating-label';
...
export default class ProductDetails extends ProductDetailsBase {
    constructor($scope, context, productAttributesData = {}) {
        ...
        this.imageGallery = new ImageGallery($('[data-image-gallery]', this.$scope), context); // custom gallery requires "context"
        this.imageGallery.init();
        
        // Store image gallery instance globally for split layout carousel access
        window.productDetails = window.productDetails || {};
        window.productDetails.imageGallery = this.imageGallery;
        ...
        this.floatingLabel = new FloatingLabel();

        customProductTabs($('.productView-description'));
    }
